...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let tableView = UINavigationController(rootViewController: TableBookController())
        ...
        // WhisList controller
        let wishList = UINavigationController(rootViewController: TableBookController())
        ...
        // Add New controller
        let addNew = UINavigationController(rootViewController: TableBookController())
        ...
        // Rentals controller
        let rentals = UINavigationController(rootViewController: TableBookController())
        ...
        // Settings controller
        let settings = UINavigationController(rootViewController: TableBookController())
