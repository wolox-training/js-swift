...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let tableView = WBooksNavigationController(rootViewController: TableBookController())
        ...
        // WhisList controller
        let wishList = WBooksNavigationController(rootViewController: TableBookController())
        ...
        // Add New controller
        let addNew = WBooksNavigationController(rootViewController: TableBookController())
        ...
        // Rentals controller
        let rentals = WBooksNavigationController(rootViewController: TableBookController())
        ...
        // Settings controller
        let settings = WBooksNavigationController(rootViewController: TableBookController())
